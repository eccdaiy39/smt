 ...
 */
static void ep13_dbl_basic_imp(ep13_t r, fp13_t s, ep13_t p) {
	fp13_t t0, t1, t2;
 ...
 * @param[in] p					- the point to double.
 */
static void ep13_dbl_projc_imp(ep13_t r, ep13_t p) {
...
void ep13_dbl_slp_basic(ep13_t r, fp13_t s, ep13_t p) {
	if (ep13_is_infty(p)) {
		ep13_set_infty(r);
		return;
	}
