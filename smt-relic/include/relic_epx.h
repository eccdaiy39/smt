 ...
 * @param[out] p			- the point to negate.
 */
void ep13_neg(ep13_t r, ep13_t p);
 ...
 * @param[in] p				- the point to convert.
 */
void ep13_norm(ep13_t r, ep13_t p);
...
void ep13_norm_sim(ep13_t *r, ep13_t *t, int n);
 ...
 * @param[in] p				- the point.
 */
void ep13_rhs(fp13_t rhs, ep13_t p);
 ...
 * @param[in] p				- the elliptic curve point to copy.
 */
void ep13_copy(ep13_t r, ep13_t p);
/**
 * Assigns an elliptic curve point to the point at infinity.
 *
 * @param[out] p			- the point to assign.
 ...
 * @return 1 if the point is at infinity, 0 otherise.
 */
int ep13_is_infty(ep13_t p);

int ep13_cmp(ep13_t p, ep13_t q);
 ...
 * @param[in] w				- the window width.
 */
void ep13_tab(ep13_t *t, ep13_t p, int w);
 ...
 * @param[in] q				- the second point to add.
 */
void ep13_add_basic(ep13_t r, ep13_t p, ep13_t q);
 ...
 * @param[in] q				- the second point to add.
 */
void ep13_add_slp_basic(ep13_t r, fp2_t s, ep13_t p, ep13_t q);
 ...
 * @param[in] q				- the second point to add.
 */
void ep13_add_projc(ep13_t r, ep13_t p, ep13_t q);
  ...
  * @param[in] q			- the point to subtract.
  */
void ep13_sub(ep13_t r, ep13_t p, ep13_t q);
 ...
 * @param[int] p			- the point to double.
 */
void ep13_dbl_basic(ep13_t r, ep13_t p);
 ...
 * @param[in] p				- the point to double.
 */
void ep13_dbl_slp_basic(ep13_t r, fp2_t s, ep13_t p);
 ...
 * @param[in] p				- the point to double.
 */
void ep13_dbl_projc(ep13_t r, ep13_t p);
 ...
 * @param[in] i				- the power of the Frobenius map.
 */
void ep13_psi(ep13_t r, ep13_t p, int i);
/**
 ...
 * @param[in] i				- the power of the Frobenius map.
 */
void ep13_frb(ep13_t r, ep13_t p, int i);
 ...
 * @param[in] k				- the integer.
 */
void ep13_mul_monty(ep13_t r, ep13_t p, const bn_t k);
